 ...
 *
 * @property lockedTasks 被锁定的航班任务及其锁定时间的映射 / The map of locked flight tasks to their lock times
*/
class Lock(
     ...
     *
     * @param flightTask 要查询的航班任务 / The flight task to query
     * @return 任务的锁定时间，未锁定则返回 null / The locked time for the task, or null if not locked
    */
