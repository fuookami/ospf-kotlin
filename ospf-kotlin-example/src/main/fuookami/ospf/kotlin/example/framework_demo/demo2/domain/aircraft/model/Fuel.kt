 ...
 *
 * @property points 平衡臂查找的插值点列表 / The list of interpolation points for balanced arm lookup.
*/
data class FuelTankBalancedArm(
     ...
     *
     * @property volume 该点的燃油体积 / The fuel volume at this point.
     * @property takeOffBalancedArm 起飞阶段的平衡臂 / The balanced arm at takeoff phase.
     * @property landingBalancedArm 着陆阶段的平衡臂，若与起飞相同则为 null / The balanced arm at landing phase, or null if same as takeoff.
    */
    data class Point(
     ...
     * @param volume 燃油体积 / The fuel volume.
     * @return 插值后的平衡臂 / The interpolated balanced arm.
    */
 ...
 * 具有类型、容量和平衡臂查找数据的油箱。
 *
 * @property type 油箱类型 / The type of the fuel tank.
 * @property name 油箱名称标识 / The name identifier of the fuel tank.
 * @property maxVolume 油箱可容纳的最大燃油体积 / The maximum fuel volume the tank can hold.
 * @property balancedArm 该油箱的平衡臂查找表 / The balanced arm lookup table for this tank.
*/
data class FuelTank(
 ...
 *
 * @property tank 底层油箱 / The underlying fuel tank.
 * @property volume 当前燃油体积 / The current fuel volume.
 * @property weight 计算的燃油重量 / The computed fuel weight.
 * @property balancedArm 当前体积下的平衡臂 / The balanced arm at the current volume.
*/
 ...
 *
 * @property density 燃油密度 / The fuel density.
 * @property weight 总燃油重量 / The total fuel weight.
 * @property index 总燃油指数 / The total fuel index.
*/
data class FuelConstant(
    ...
    companion object {
         ...
         *
         * @param density 燃油密度 / The fuel density.
         * @param weight 总燃油重量 / The total fuel weight.
         * @param tanks 油箱视图列表 / The list of fuel tank views.
         * @param aircraftModel 用于单位定义的飞机型号 / The aircraft model for unit definitions.
         * @param formula 用于指数计算的气动公式 / The aerodynamic formula for index computation.
         * @return 计算的燃油常数 / The computed FuelConstant.
        */
        operator fun invoke(
