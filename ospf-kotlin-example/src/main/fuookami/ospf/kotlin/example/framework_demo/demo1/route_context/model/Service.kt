 ...
 *
 * @property id 唯一服务标识符 / the unique service identifier
 * @property capacity 该服务的带宽容量 / the bandwidth capacity of this service
 * @property cost 该服务的每次使用成本 / the cost per use of this service
*/
class Service(
    val id: UInt64,
    val capacity: UInt64,
