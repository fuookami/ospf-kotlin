 ...
 *
 * @property location 该装载顺序适用的甲板位置 / The deck location this loading order applies to.
 * @property order 线性装载顺序索引 / The linear loading order index.
 * @property directPrec 必须在此位置之前直接装载的位置集合 / The set of positions that must be loaded directly before this one.
 * @property directSucc 必须在此位置之后直接装载的位置集合 / The set of positions that must be loaded directly after this one.
*/
 ...
 * @param other 要比较的位置 / The position to compare against
 * @return 如果另一位置在此位置的后继集合中则为 true / true if the other position is in this position's successor set
*/
 ...
 * @param other 要比较的位置 / The position to compare against
 * @return 如果另一位置不在此位置的前驱集合中则为 true / true if the other position is not in this position's predecessor set
*/
 ...
 * @param other 要比较的位置 / The position to compare against
 * @return 如果另一位置在此位置的前驱集合中则为 true / true if the other position is in this position's predecessor set
*/
 ...
 * @param other 要比较的位置 / The position to compare against
 * @return 如果另一位置不在此位置的后继集合中则为 true / true if the other position is not in this position's successor set
*/
