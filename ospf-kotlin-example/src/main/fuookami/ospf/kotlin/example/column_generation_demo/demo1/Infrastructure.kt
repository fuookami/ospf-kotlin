...
suspend fun solveMIP(name: String, metaModel: LinearMetaModel, parameter: SolverParameter, config: LinearSolverConfig = LinearSolverConfig()): Result<List<Flt64>, Error> {
...
suspend fun solveMIP(name: String, metaModel: LinearMetaModel, parameter: SolverParameter, amount: UInt64): Result<List<List<Flt64>>, Error> {
...
suspend fun solveLP(name: String, metaModel: LinearMetaModel, parameter: SolverParameter): Result<LPResult, Error> {
    // GlobalScope.launch(Dispatchers.IO) { metaModel.export("$name.opm") }
