...
/**
 * 解析结果格式，异常值回退到 JSON。 / Parse result format and fallback to JSON on invalid input.
 *
...
/**
 * 过滤 regex 以生成稳定可读的文件名。 / Sanitize regex text for stable and readable file names.
 *
