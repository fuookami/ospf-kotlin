 ...
 *
 * 本文件提供影子价格键的安全类型转换工具函数。 / This file provides utility functions for safe type casting of shadow price keys.
*/
 ...
 * 约束分组由对应 pipeline 构造，运行期 key 类型不变量由构造路径保证。 / Safely narrows constraint args to the target shadow-price key type.
