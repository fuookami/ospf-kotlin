/**
 * 生产动作接口 / Production Action Interface
 *
 * 生产动作表示产能的生产方式。 / A production action represents a way to produce capacity.
 *
 * 分为： / Can be:
...
interface ProductionAction {
    ...
    /**
     * 动作唯一标识 / Unique identifier for the action
    */
    val id: ProductionActionId

    /**
     * 动作名称 / Name of the action
    */
    val name: String
    val displayName: String get() = name

    /**
     * 执行者 / The executor that performs this action
    */
    ...
    */
    ...
    /**
     * 批次时长（仅离散型有效） / Batch duration (only for discrete actions)
    */
    val batchDuration: Duration? get() = null

    /**
     * 每个单位 x 对应的产能 / Unit capacity per x value
     *
     * @param timeWindow 时间窗口 / Time window
     * @return 单位产能 / Unit capacity
    */
    ...
    */
     ...
     * @return 单位产能物理量 / Unit capacity as Quantity<V>
    */
     ...
     * @return 单位成本物理量 / Unit cost as Quantity<V>
    */
     ...
     *
     * @param time 时间点 / Time instant
     * @return 求解器单位成本 / Unit cost for solver
    */
