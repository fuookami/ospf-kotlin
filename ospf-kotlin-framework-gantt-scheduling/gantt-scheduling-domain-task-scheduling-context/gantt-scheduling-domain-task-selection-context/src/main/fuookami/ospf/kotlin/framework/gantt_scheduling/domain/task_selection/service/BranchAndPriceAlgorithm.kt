...
import fuookami.ospf.kotlin.framework.gantt_scheduling.domain.task_scheduling.*
...
>(
    ...
    data class Policy<
        ...
        A : AssignmentPolicy<E>
    >(
        val contextBuilder: () -> IterativeTaskSchedulingContext<Args, IT, T, E, A>,
        val extractContextBuilder: List<(IterativeTaskSchedulingContext<Args, IT, T, E, A>) -> List<ExtractIterativeTaskSchedulingContext<Args, IT, T, E, A>>>,
