...
class ResourceOverCapacityMinimization<Args : GanttSchedulingShadowPriceArguments<E, A>, E : Executor, A : AssignmentPolicy<E>, S : ResourceTimeSlot<R, C>, R : Resource<C>, C : ResourceCapacity>(
        ...
        if (slots.isNotEmpty()) {
            ...
            for (slot in slots) {
                ...
                if (thresholdValue eq Flt64.zero) {
                    cost += coefficient * quantity.overQuantity[slot]
                } else {
