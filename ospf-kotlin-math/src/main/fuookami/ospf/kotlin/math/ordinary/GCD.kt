 ...
 * 数学定义：gcd(a, b) 是能同时整除 a �?b 的最大正整数�?
 * 对于 a = 0 �?b = 0，gcd(a, 0) = |a|，gcd(0, b) = |b|，gcd(0, 0) = 0�?
 * 扩展欧几里得算法同时求解 gcd(a, b) = ax + by 的整数解 x �?y（贝祖等式）�?
 * 对于浮点�?FltX，先通过乘以 10 的幂次将小数转换为整数，再计�?GCD�?
 * 对于有理�?RtnX，gcd(a/b, c/d) = gcd(a, c) / lcm(b, d)�?
