 ...
 * 用于需要增量构建或修改多项式的场景，构建完成后可转换为不可变的 QuadraticPolynomial。 / Provides a mutable version of quadratic polynomials, supporting in-place modifications.
 ...
 *
 * 二次多项式的可变版本，支持原地修改操作。
 * 用于需要增量构建或修改多项式的场景，构建完成后可转换为不可变的 [QuadraticPolynomial]。 / A mutable version of quadratic polynomials, supporting in-place modifications.
...
class MutableQuadraticPolynomial<T : NumberField<T>>(
    ...
    /**
     * 二次单项式列表（只读） / List of quadratic monomials (read-only)
    */
    ...
    */
     ...
     *
     * 如果包含真正的二次项，则返回 Quadratic；否则返回 Linear。 / Returns Quadratic if there are true quadratic terms; otherwise returns Linear.
    */
    ...
    companion object {
        /**
         * 创建零多项式（常数项为 0） / Creates a zero polynomial (constant = 0)
         *
        ...
        */
        ...
        /**
         * 创建值为 1 的常数多项式 / Creates a constant polynomial with value 1
         *
        ...
        */
        ...
        /**
         * 使用指定值创建常数多项式 / Creates a constant polynomial with the given value
         *
    ...
    /**
     * 添加二次单项式 / Adds a quadratic monomial
     *
    ...
    */
    ...
    /**
     * 添加线性单项式（转换为二次单项式形式） / Adds a linear monomial (converted to quadratic monomial form)
     *
    ...
    */
    ...
    /**
     * 增加常数项 / Adds to the constant term
     *
    ...
    */
    ...
    /**
     * 转换为不可变的二次多项式 / Converts to an immutable quadratic polynomial
     *
    ...
    */
    ...
    /**
     * 转换为不可变形式 / Converts to immutable form
     *
     * @return 不可变的二次多项式 / Immutable quadratic polynomial
    */
...
/**
 * 将不可变二次多项式转换为可变形式 / Converts an immutable quadratic polynomial to mutable form
 *
...
/**
 * 将可变二次多项式转换为不可变形式 / Converts a mutable quadratic polynomial to immutable form
 *
...
/**
 * 可变二次多项式的负运算符 / Negation operator for mutable quadratic polynomial
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的加法赋值运算符（二次单项式） / Addition assignment operator for mutable quadratic polynomial (quadratic monomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的加法赋值运算符（线性单项式） / Addition assignment operator for mutable quadratic polynomial (linear monomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的加法赋值运算符（二次多项式） / Addition assignment operator for mutable quadratic polynomial (quadratic polynomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的加法赋值运算符（可变二次多项式） / Addition assignment operator for mutable quadratic polynomial (mutable quadratic polynomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的加法赋值运算符（线性多项式） / Addition assignment operator for mutable quadratic polynomial (linear polynomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的加法赋值运算符（标量） / Addition assignment operator for mutable quadratic polynomial (scalar)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
...
/**
 * 可变二次多项式的减法赋值运算符（二次单项式） / Subtraction assignment operator for mutable quadratic polynomial (quadratic monomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 二次单项式 / Quadratic monomial
*/
...
/**
 * 可变二次多项式的减法赋值运算符（线性单项式） / Subtraction assignment operator for mutable quadratic polynomial (linear monomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 线性单项式 / Linear monomial
*/
...
/**
 * 可变二次多项式的减法赋值运算符（二次多项式） / Subtraction assignment operator for mutable quadratic polynomial (quadratic polynomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 二次多项式 / Quadratic polynomial
*/
...
/**
 * 可变二次多项式的减法赋值运算符（可变二次多项式） / Subtraction assignment operator for mutable quadratic polynomial (mutable quadratic polynomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 可变二次多项式 / Mutable quadratic polynomial
*/
...
/**
 * 可变二次多项式的减法赋值运算符（线性多项式） / Subtraction assignment operator for mutable quadratic polynomial (linear polynomial)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 线性多项式 / Linear polynomial
*/
...
/**
 * 可变二次多项式的减法赋值运算符（标量） / Subtraction assignment operator for mutable quadratic polynomial (scalar)
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 标量值 / Scalar value
*/
...
/**
 * 可变二次多项式的乘法赋值运算符 / Multiplication assignment operator for mutable quadratic polynomial
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 标量值 / Scalar value
*/
...
/**
 * 可变二次多项式的除法赋值运算符 / Division assignment operator for mutable quadratic polynomial
 *
 * @receiver 可变二次多项式 / Mutable quadratic polynomial
 * @param rhs 标量值 / Scalar value
*/
