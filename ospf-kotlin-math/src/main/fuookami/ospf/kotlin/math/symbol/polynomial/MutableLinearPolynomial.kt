 ...
 * 用于需要增量构建或修改多项式的场景，构建完成后可转换为不可变的 LinearPolynomial。 / Provides a mutable version of linear polynomials, supporting in-place modifications.
 ...
 *
 * 线性多项式的可变版本，支持原地修改操作。
 * 用于需要增量构建或修改多项式的场景，构建完成后可转换为不可变的 [LinearPolynomial]。 / A mutable version of linear polynomials, supporting in-place modifications.
...
class MutableLinearPolynomial<T : NumberField<T>>(
    ...
    /**
     * 线性单项式列表（只读） / List of linear monomials (read-only)
    */
    ...
    */
     ...
     *
     * 可变线性多项式总是属于线性类型。 / Mutable linear polynomials always belong to the Linear category.
    */
    ...
    companion object {
        ...
        */
         ...
         *
         * 当需要特定的常数值或 T 不支持反射时使用此方法。 / Use this when you need a specific constant or when T doesn't support reflection.
         *
    ...
    /**
     * 添加线性单项式 / Adds a linear monomial
     *
    ...
    */
    ...
    /**
     * 转换为不可变的线性多项式 / Converts to an immutable linear polynomial
     *
...
/**
 * 将不可变线性多项式转换为可变形式 / Converts an immutable linear polynomial to mutable form
 *
...
/**
 * 将可变线性多项式转换为不可变形式 / Converts a mutable linear polynomial to immutable form
 *
...
/**
 * 可变线性多项式的负运算符 / Negation operator for mutable linear polynomial
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
...
/**
 * 可变线性多项式的加法赋值运算符（单项式） / Addition assignment operator for mutable linear polynomial (monomial)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
...
/**
 * 可变线性多项式的加法赋值运算符（多项式） / Addition assignment operator for mutable linear polynomial (polynomial)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
...
/**
 * 可变线性多项式的加法赋值运算符（可变多项式） / Addition assignment operator for mutable linear polynomial (mutable polynomial)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
...
/**
 * 可变线性多项式的加法赋值运算符（标量） / Addition assignment operator for mutable linear polynomial (scalar)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
...
/**
 * 可变线性多项式的减法赋值运算符（单项式） / Subtraction assignment operator for mutable linear polynomial (monomial)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
 * @param rhs 线性单项式 / Linear monomial
*/
...
/**
 * 可变线性多项式的减法赋值运算符（多项式） / Subtraction assignment operator for mutable linear polynomial (polynomial)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
 * @param rhs 线性多项式 / Linear polynomial
*/
...
/**
 * 可变线性多项式的减法赋值运算符（可变多项式） / Subtraction assignment operator for mutable linear polynomial (mutable polynomial)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
 * @param rhs 可变线性多项式 / Mutable linear polynomial
*/
...
/**
 * 可变线性多项式的减法赋值运算符（标量） / Subtraction assignment operator for mutable linear polynomial (scalar)
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
 * @param rhs 标量值 / Scalar value
*/
...
/**
 * 可变线性多项式的乘法赋值运算符 / Multiplication assignment operator for mutable linear polynomial
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
 * @param rhs 标量值 / Scalar value
*/
...
/**
 * 可变线性多项式的除法赋值运算符 / Division assignment operator for mutable linear polynomial
 *
 * @receiver 可变线性多项式 / Mutable linear polynomial
 * @param rhs 标量值 / Scalar value
*/
