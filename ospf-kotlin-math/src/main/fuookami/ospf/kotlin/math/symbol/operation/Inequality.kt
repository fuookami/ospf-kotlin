...
/**
 * Flt64 不等式 DSL 和求值 / Flt64 Inequality DSL and Evaluation
 *
 * 提供 Flt64 不等式的符号级 DSL（lt/le/eq/ne/ge/gt）和满足性判断。 / Supports symbol-level comparison DSL and satisfaction checking for Flt64 inequalities.
*/

// ========== Comparison.satisfiedBy ==========

/**
 * 判断 Flt64 值是否满足比较关系 / Check if Flt64 values satisfy the comparison relation
 *
 ...
 * 将符号转换为系数为 1 的线性多项式。
 *
 * @return 此符号的线性多项式表示 / the linear polynomial representation of this symbol
*/
 ...
 * 将 Flt64 值转换为常数线性多项式。
 *
 * @return 此值的常数线性多项式表示 / the constant linear polynomial representation of this value
*/
 ...
 *
 * @param rhs 右侧 Flt64 值 / the right-hand side Flt64 value
 * @return 表示 this < rhs 的线性不等式 / the linear inequality representing this < rhs
*/
 ...
 *
 * @param rhs 右侧符号 / the right-hand side symbol
 * @return 表示 this < rhs 的线性不等式 / the linear inequality representing this < rhs
*/
...
/**
 * 判断 Flt64 线性不等式是否被给定值满足 / Check if a Flt64 linear inequality is satisfied by given values
 *
...
/**
 * 判断 Flt64 线性不等式是否被有序值满足 / Check if a Flt64 linear inequality is satisfied by ordered values
 *
...
/**
 * 判断 Flt64 二次不等式是否被给定值满足 / Check if a Flt64 quadratic inequality is satisfied by given values
 *
 * @param values 符号到值的映射 / Symbol-to-value mapping
 * @return 是否满足，若缺少值则返回 null / Whether satisfied, or null if values are missing
*/
...
/**
 * 判断 Flt64 二次不等式是否被有序值满足 / Check if a Flt64 quadratic inequality is satisfied by ordered values
 *
 * @param order 符号顺序 / Symbol order
 * @param values 对应值列表 / Corresponding value list
 * @return 是否满足 / Whether satisfied
...
/**
 * 判断 Flt64 规范不等式是否被给定值满足 / Check if a Flt64 canonical inequality is satisfied by given values
 *
 * @param values 符号到值的映射 / Symbol-to-value mapping
 * @return 是否满足，若缺少值则返回 null / Whether satisfied, or null if values are missing
*/
...
/**
 * 判断 Flt64 规范不等式是否被有序值满足 / Check if a Flt64 canonical inequality is satisfied by ordered values
 *
 * @param order 符号顺序 / Symbol order
 * @param values 对应值列表 / Corresponding value list
 * @return 是否满足 / Whether satisfied
