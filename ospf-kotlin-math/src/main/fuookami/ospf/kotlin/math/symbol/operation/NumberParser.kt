/**
 * Flt64 数字解析器 / Flt64 Number Parser
 *
 * 提供将文本字符串解析为 Flt64 数值的功能。 / Provides parsing of text strings into Flt64 numeric values.
*/
...
/**
 * Flt64 数字解析器单例 / Flt64 number parser singleton
 *
...
data object Flt64NumberParser : NumberParser<Flt64> {
    ...
    /**
     * 将文本解析为 Flt64 数值 / Parse text into a Flt64 value
     *
