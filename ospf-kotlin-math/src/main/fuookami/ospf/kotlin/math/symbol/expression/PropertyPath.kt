 ...
 *
 * 核心特性 / Core Features:
 * - 统一存储为 `value: String` / Unified storage as `value: String`
...
value class PropertyPath(val value: String) {
     ...
     *
     * @return 根分段，如果路径为空则返回 null / Root segment, null if path is empty
     */
    val root: String?
     ...
     *
     * @return 叶分段，如果路径为空则返回 null / Leaf segment, null if path is empty
     */
    val leaf: String?
    ...
    companion object {
         ...
         *
         * @param text 路径文本 / Path text
         * @return 解析的路径，如果文本无效则返回 null / Parsed path, null if text is invalid
         */
