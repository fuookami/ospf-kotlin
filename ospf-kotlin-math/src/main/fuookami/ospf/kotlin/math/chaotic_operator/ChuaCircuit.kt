 ...
 * Chua's Circuit
 *
 * 蔡氏电路是由 Leon O. Chua �?1983 年设计的简单电子电路，是第一个被实验验证的混沌电路�?
...
data class ChuaCircuit<V : FloatingNumber<V>>(
    ...
    companion object {
        operator fun invoke(
            ...
            d: Flt64 = Flt64(-1.14),
            h: Flt64 = Flt64(0.01)
        ): ChuaCircuit<fuookami.ospf.kotlin.math.algebra.number.Flt64> {
...
data class ChuaCircuitGenerator(
    val chuaCircuit: ChuaCircuit<fuookami.ospf.kotlin.math.algebra.number.Flt64> = ChuaCircuit(),
