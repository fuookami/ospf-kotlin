 ...
 * Chen-Lee Attractor
 *
 * Chen-Lee 吸引子是�?Chen �?Lee 提出的三维混沌系统�?
...
data class ChenLeeAttractor<V : FloatingNumber<V>>(
    ...
    companion object {
        operator fun invoke(
            ...
            h: Flt64 = Flt64(0.01)
        ): ChenLeeAttractor<fuookami.ospf.kotlin.math.algebra.number.Flt64> {
...
data class ChenLeeAttractorGenerator(
    val chenLeeAttractor: ChenLeeAttractor<fuookami.ospf.kotlin.math.algebra.number.Flt64> = ChenLeeAttractor(),
