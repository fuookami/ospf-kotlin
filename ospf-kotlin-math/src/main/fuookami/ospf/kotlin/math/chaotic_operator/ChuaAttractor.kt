 ...
 * Chua's Attractor
 *
 * 蔡氏吸引子是�?Leon O. Chua 提出的著名混沌系统，是蔡氏电路的数学模型�?
...
data class ChuaAttractor<V : FloatingNumber<V>>(
    ...
    companion object {
        operator fun invoke(
            ...
            h: Flt64 = Flt64(0.01)
        ): ChuaAttractor<fuookami.ospf.kotlin.math.algebra.number.Flt64> {
...
data class ChuaAttractorGenerator(
    val chuaAttractor: ChuaAttractor<fuookami.ospf.kotlin.math.algebra.number.Flt64> = ChuaAttractor(),
