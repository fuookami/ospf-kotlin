 ...
 *
 * 用于将 ValueRange 序列化和反序列化为 JSON 格式，包含上下边界值和区间类型。
 ...
 * @property valueSerializer 值包装器的序列化器
 */
...
data class ValueRange<T>(
     ...
     *
     * 格式为 [lower, upper] 或 (lower, upper) 等。
