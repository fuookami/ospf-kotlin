 ...
 *
 * 用于�?ValueWrapper 序列化和反序列化�?JSON 格式，支持普通值、正无穷和负无穷的表示�?
...
class ValueWrapperSerializer<T>(
     ...
     *
     * 定义了三种可能的序列化形式：Value、Infinity �?NegativeInfinity�?
     ...
     *
     * �?JSON 元素解析值包装器�?
     * - Double.POSITIVE_INFINITY：解析为正无�?
     * - Double.NEGATIVE_INFINITY：解析为负无�?
     * - 其他数值：解析为普通�?
     *
...
sealed class ValueWrapper<T>(
    ...
    class Infinity<T>(constants: RealNumberConstants<T>) :
         ...
         * @param rhs 要添加的数�?
         * @return 正无穷值包装器
         * @throws IllegalArgumentException 当加�?NaN 或负无穷�?
         */
         ...
         * @param rhs 另一个值包装器
         * @return 新的值包装器
         * @throws IllegalArgumentException 当加上负无穷�?
         */
        @Throws(IllegalArgumentException::class)
        override fun plus(rhs: ValueWrapper<T>): ValueWrapper<T> = when (rhs) {
         ...
         * @param rhs 要减去的数�?
         * @return 正无穷值包装器
         * @throws IllegalArgumentException 当减�?NaN 或正无穷�?
         */
        @Throws(IllegalArgumentException::class)
         ...
         * @param rhs 另一个值包装器
         * @return 新的值包装器
         * @throws IllegalArgumentException 当减去正无穷�?
         */
        @Throws(IllegalArgumentException::class)
        override fun minus(rhs: ValueWrapper<T>): ValueWrapper<T> = when (rhs) {
            is Value -> Infinity(constants)
         ...
         * @param rhs 要乘的数�?
         * @return 新的值包装器
         * @throws IllegalArgumentException 当乘�?NaN �?
         */
        @Throws(IllegalArgumentException::class)
         ...
         * @param rhs 要除的数�?
         * @return 新的值包装器
         * @throws IllegalArgumentException 当除�?NaN、无穷或零时
         */
        @Throws(IllegalArgumentException::class)
    ...
    class NegativeInfinity<T>(constants: RealNumberConstants<T>) :
         ...
         * @param rhs 要添加的数�?
         * @return 负无穷值包装器
         * @throws IllegalArgumentException 当加�?NaN 或正无穷�?
         */
        @Throws(IllegalArgumentException::class)
        override fun plus(rhs: T): ValueWrapper<T> = when (rhs) {
            rhs.constants.nan -> throw IllegalArgumentException("Invalid plus between inf and nan!!!")
         ...
         * @param rhs 另一个值包装器
         * @return 新的值包装器
         * @throws IllegalArgumentException 当加上正无穷�?
         */
        @Throws(IllegalArgumentException::class)
        override fun plus(rhs: ValueWrapper<T>): ValueWrapper<T> = when (rhs) {
         ...
         * @param rhs 要减去的数�?
         * @return 负无穷值包装器
         * @throws IllegalArgumentException 当减�?NaN 或负无穷�?
         */
        @Throws(IllegalArgumentException::class)
        override fun minus(rhs: T): ValueWrapper<T> = when (rhs) {
            rhs.constants.nan -> throw IllegalArgumentException("Invalid minus between -inf and nan!!!")
         ...
         * @param rhs 另一个值包装器
         * @return 新的值包装器
         * @throws IllegalArgumentException 当减去负无穷�?
         */
        @Throws(IllegalArgumentException::class)
        override fun minus(rhs: ValueWrapper<T>): ValueWrapper<T> = when (rhs) {
            is Value -> NegativeInfinity(constants)
