 ...
 * 数概念 / Number Concepts
 *
 * 定义数值类型的核心接口，包括数环、数域、标量、实数、整数、有理数、浮点数等数值类型层次结构。 / Defines core interfaces for numeric types, including number ring, number field, scalar, real number, integer, rational number, floating number and other numeric type hierarchies.
*/
 ...
 *
 * 数环是具有加法群结构和乘法半群结构的代数结构。 / A number ring is an algebraic structure with additive group structure and multiplicative semigroup structure.
*/
 ...
 *
 * 数域是具有加法群结构和乘法群结构的代数结构。 / A number field is an algebraic structure with additive group structure and multiplicative group structure.
*/
 ...
 *
 * 标量是支持加法、乘法、叉积和绝对值运算的算术类型。 / A scalar is an arithmetic type that supports addition, multiplication, cross product, and absolute value operations.
 *
...
interface Scalar<Self : Scalar<Self>> : Arithmetic<Self>,
    ...
    /**
     * 叉积运算，默认实现为乘法 / Cross product operation, default implementation is multiplication
     *
     * @param rhs 另一个标量
     * @return 叉积结果
...
/**
 * 实数接口 / Real Number Interface
 *
 * 实数是具有序关系、有界性、无穷性、定点性和精度特性的标量类型，
 * 支持对数、幂、指数和三角函数运算。 / A real number is a scalar type with ordering, boundedness, infinity, fixed-point, and precision characteristics,
...
interface RealNumber<Self : RealNumber<Self>> : Scalar<Self>, Invariant<Self>, Ord<Self>, Eq<Self>,
    ...
    */
    ...
    /**
     * 是否定点 / Whether the number is fixed-point
    */
    ...
    */
    ...
    /**
     * 判断是否为正无穷 / Check if the number is positive infinity
     *
     * @return 是否为正无穷
    ...
    */
    ...
    /**
     * 判断当前值是否为正无穷 / Check whether the current value is positive infinity
     *
     * @return 是否为正无穷
    ...
    */
    ...
    /**
     * 判断是否为负无穷 / Check if the number is negative infinity
     *
     * @return 是否为负无穷
    ...
    */
    ...
    /**
     * 判断当前值是否为无穷（正无穷或负无穷） / Check whether the current value is infinite (positive or negative infinity)
     *
     * @return 是否为无穷
    ...
    */
    ...
    /**
     * 判断当前值是否为有限值 / Check whether the current value is finite
     *
     * @return 是否为有限值
    ...
    */
    ...
    /**
     * 判断当前值是否在边界范围内 / Check whether the current value is within bounds
     *
     * @return 是否在边界内
    ...
    */
    ...
    /**
     * 将当前值限制在边界范围内 / Clamp the current value to within bounds
     *
     * @return 限制后的值
    ...
    */
    ...
    /**
     * 转换为 8 位有符号整数 / Convert to 8-bit signed integer
     *
     * @return Int8 值
    */
    fun toInt8(): Int8
    ...
    /**
     * 转换为 16 位有符号整数 / Convert to 16-bit signed integer
     *
     * @return Int16 值
    */
    fun toInt16(): Int16
    ...
    /**
     * 转换为 32 位有符号整数 / Convert to 32-bit signed integer
     *
     * @return Int32 值
    */
    fun toInt32(): Int32
    ...
    /**
     * 转换为 64 位有符号整数 / Convert to 64-bit signed integer
     *
     * @return Int64 值
    */
    fun toInt64(): Int64
    ...
    /**
     * 转换为任意精度有符号整数 / Convert to arbitrary precision signed integer
     *
     * @return IntX 值
    */
    fun toIntX(): IntX
    ...
    /**
     * 转换为 8 位无符号整数 / Convert to 8-bit unsigned integer
     *
     * @return UInt8 值
    */
    fun toUInt8(): UInt8
    ...
    /**
     * 转换为 16 位无符号整数 / Convert to 16-bit unsigned integer
     *
     * @return UInt16 值
    */
    fun toUInt16(): UInt16
    ...
    /**
     * 转换为 32 位无符号整数 / Convert to 32-bit unsigned integer
     *
     * @return UInt32 值
    */
    fun toUInt32(): UInt32
    ...
    /**
     * 转换为 64 位无符号整数 / Convert to 64-bit unsigned integer
     *
     * @return UInt64 值
    */
    fun toUInt64(): UInt64
    ...
    /**
     * 转换为任意精度无符号整数 / Convert to arbitrary precision unsigned integer
     *
     * @return UIntX 值
    */
    fun toUIntX(): UIntX
    ...
    /**
     * 转换为可空 8 位有符号整数 / Convert to nullable 8-bit signed integer
     *
     * @return NInt8 值
    */
    ...
    /**
     * 转换为可空 16 位有符号整数 / Convert to nullable 16-bit signed integer
     *
     * @return NInt16 值
    */
    ...
    /**
     * 转换为可空 32 位有符号整数 / Convert to nullable 32-bit signed integer
     *
     * @return NInt32 值
    */
    ...
    /**
     * 转换为可空 64 位有符号整数 / Convert to nullable 64-bit signed integer
     *
     * @return NInt64 值
    */
    ...
    /**
     * 转换为可空任意精度有符号整数 / Convert to nullable arbitrary precision signed integer
     *
     * @return NIntX 值
    */
    ...
    /**
     * 转换为可空 8 位无符号整数 / Convert to nullable 8-bit unsigned integer
     *
     * @return NUInt8 值
    */
    ...
    /**
     * 转换为可空 16 位无符号整数 / Convert to nullable 16-bit unsigned integer
     *
     * @return NUInt16 值
    */
    ...
    /**
     * 转换为可空 32 位无符号整数 / Convert to nullable 32-bit unsigned integer
     *
     * @return NUInt32 值
    */
    ...
    /**
     * 转换为可空 64 位无符号整数 / Convert to nullable 64-bit unsigned integer
     *
     * @return NUInt64 值
    */
    ...
    /**
     * 转换为可空任意精度无符号整数 / Convert to nullable arbitrary precision unsigned integer
     *
     * @return NUIntX 值
    */
    ...
    /**
     * 转换为 8 位有符号整数比率 / Convert to 8-bit signed integer ratio
     *
     * @return Rtn8 值
    */
    ...
    /**
     * 转换为 16 位有符号整数比率 / Convert to 16-bit signed integer ratio
     *
     * @return Rtn16 值
    */
    ...
    /**
     * 转换为 32 位有符号整数比率 / Convert to 32-bit signed integer ratio
     *
     * @return Rtn32 值
    */
    ...
    /**
     * 转换为 64 位有符号整数比率 / Convert to 64-bit signed integer ratio
     *
     * @return Rtn64 值
    */
    ...
    /**
     * 转换为任意精度有符号整数比率 / Convert to arbitrary precision signed integer ratio
     *
     * @return RtnX 值
    */
    ...
    /**
     * 转换为 8 位无符号整数比率 / Convert to 8-bit unsigned integer ratio
     *
     * @return URtn8 值
    */
    ...
    /**
     * 转换为 16 位无符号整数比率 / Convert to 16-bit unsigned integer ratio
     *
     * @return URtn16 值
    */
    ...
    /**
     * 转换为 32 位无符号整数比率 / Convert to 32-bit unsigned integer ratio
     *
     * @return URtn32 值
    */
    ...
    /**
     * 转换为 64 位无符号整数比率 / Convert to 64-bit unsigned integer ratio
     *
     * @return URtn64 值
    */
    ...
    /**
     * 转换为任意精度无符号整数比率 / Convert to arbitrary precision unsigned integer ratio
     *
     * @return URtnX 值
    */
    ...
    /**
     * 转换为 32 位浮点数 / Convert to 32-bit floating point number
     *
     * @return Flt32 值
    */
    fun toFlt32(): Flt32
    ...
    /**
     * 转换为 64 位浮点数 / Convert to 64-bit floating point number
     *
     * @return Flt64 值
    */
    fun toFlt64(): Flt64
    ...
    /**
     * 转换为任意精度浮点数 / Convert to arbitrary precision floating point number
     *
     * @return FltX 值
    */
    fun toFltX(): FltX
...
/**
 * 实数常量接口 / Real Number Constants Interface
 *
 * 提供实数类型的基本常量。 / Provides basic constants for real number types.
 *
 * @param Self 实数类型，必须继承自 RealNumber
*/
interface RealNumberConstants<Self : RealNumber<Self>> : ArithmeticConstants<Self>, RealConst<Self> {
    ...
    */
    ...
    /**
     * 正最小值，默认为一 / Positive minimum value, defaults to one
    */
    val positiveMinimum get() = one

    /**
     * 小数位数，默认为空 / Decimal digits, defaults to null
    */
    override val decimalDigits: Int? get() = null

    /**
     * 小数精度值，默认为零 / Decimal precision value, defaults to zero
    */
    override val decimalPrecision: Self get() = zero

    /**
     * 精度误差值，默认为零 / Precision epsilon value, defaults to zero
    */
    override val epsilon: Self get() = zero

    /**
     * NaN 值，默认为空 / NaN value, defaults to null
    */
    override val nan: Self? get() = null

    /**
     * 正无穷值，默认为空 / Positive infinity value, defaults to null
    */
    override val infinity: Self? get() = null

    /**
     * 负无穷值，默认为空 / Negative infinity value, defaults to null
    */
 ...
 *
 * 整数是支持范围运算的实数类型。 / An integer is a real number type that supports range operations.
 *
...
/**
 * 有符号整数接口 / Integer Number Interface
 *
 * 有符号整数是支持幂运算的数域整数类型。 / A signed integer is an integer number field type that supports power operations.
 *
 ...
 *
 * 无符号整数是支持幂运算的数域整数类型。 / An unsigned integer is an integer number field type that supports power operations.
 *
 ...
 *
 * 有理数是由两个整数构成的比例表示的数域实数类型。 / A rational number is a real number field type represented by a ratio of two integers.
 *
 ...
 *
 * 提供有理数类型的常量，包括半值常量。 / Provides constants for rational number types, including half value constant.
 *
 * @param Self 有理数类型，必须继承自 RationalNumber
 * @param I 整数类型
*/
 ...
 *
 * 浮点数是支持幂运算和倒数的数域实数类型。 / A floating number is a real number field type that supports power operations and reciprocal.
 *
...
interface FloatingNumber<Self : FloatingNumber<Self>> : RealNumber<Self>, NumberField<Self>, Pow<Self> {
    ...
    /**
     * 浮点数常量 / Floating number constants
    */
 ...
 *
 * 提供浮点数类型的常量，包括半值、圆周率、自然常数和常用对数常量。 / Provides constants for floating number types, including half, pi, e, and lg2 constants.
 *
 * @param Self 浮点数类型，必须继承自 FloatingNumber
*/
interface FloatingNumberConstants<Self : FloatingNumber<Self>> : RealNumberConstants<Self>, FloatingConst<Self> {
    ...
    /**
     * 正最小值，默认为精度误差值 / Positive minimum value, defaults to epsilon
    */
    ...
    */
    ...
    /**
     * 以 2 为底的常用对数常量 / Log base 2 constant
    */
    override val lg2: Self
}

/**
 * 数值有符号整数接口 / Numeric Integer Number Interface
 *
 * 数值有符号整数是支持加法群、乘法半群、倒数、除法、整除、取余和幂运算的整数类型。 / A numeric integer number is an integer type that supports additive group, multiplicative semigroup, reciprocal, division, integer division, remainder, and power operations.
 *
...
/**
 * 数值无符号整数接口 / Numeric Unsigned Integer Number Interface
 *
 * 数值无符号整数是支持加法半群、乘法半群、自减、取负、减法、倒数、除法、整除、取余和幂运算的整数类型。 / A numeric unsigned integer number is an integer type that supports additive semigroup, multiplicative semigroup, decrement, negation, subtraction, reciprocal, division, integer division, remainder, and power operations.
 *
