 ...
 *
 * 反三角函敌/ Inverse trigonometric functions:
 * - asin(x): 反正弦函敌/ arcsine function
 * - acos(x): 反余弦函敌/ arccosine function
 * - atan(x): 反正切函敌/ arctangent function
 * - asec(x): 反正割函敌/ arcsecant function
 * - acsc(x): 反余割函敌/ arccosecant function
 * - acot(x): 反余切函敌/ arccotangent function
 *
 ...
 *
 * 反双曲函敌/ Inverse hyperbolic functions:
 * - asinh(x): 反双曲正弌/ inverse hyperbolic sine
 * - acosh(x): 反双曲余弌/ inverse hyperbolic cosine
 * - atanh(x): 反双曲正刌/ inverse hyperbolic tangent
