...
class Precision<T>(
     ...
     *
     * @param other 要比较的另一个数
     * @return 比较结果，可以是 Equal、Less 或 Greater
     *
     * @param other The other number to compare with
     ...
     *
     * @param other 要比较的另一个数
     * @return 如果当前数明显小于另一个数（差值大于等于精度）则返回 true
     *
     * @param other The other number to compare with
     ...
     *
     * @param other 要比较的另一个数
     * @return 如果当前数小于等于另一个数（差值小于等于精度）则返回 true
     *
     * @param other The other number to compare with
     ...
     *
     * @param other 要比较的另一个数
     * @return 如果当前数明显大于另一个数（差值大于精度）则返回 true
     *
     * @param other The other number to compare with
     ...
     *
     * @param other 要比较的另一个数
     * @return 如果当前数大于等于另一个数（差值小于等于精度）则返回 true
     *
     * @param other The other number to compare with
 ...
 *
 * @param T 数值类型
 * @param constants 实数常量提供者
 * @param precision 比较精度，默认使用类型的十进制精度
 * @return 精度比较工具实例
 *
