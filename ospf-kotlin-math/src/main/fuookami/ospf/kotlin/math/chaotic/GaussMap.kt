 ...
 * 常用于混沌理论研究、伪随机数生成和混沌迭代分析。 / The Gauss map is a simple one-dimensional chaotic map that generates chaotic behavior through modulo operations.
