 ...
 * 常用于混沌动力学教学、非线性力学研究和物理演示。 / The double pendulum system is a classical mechanical system composed of two connected pendulums, serving as a typical example demonstrating chaotic motion.
...
data class DoublePendulumSystem(
    ...
    /**
     * 计算双摆系统的下一步状态 / Compute the next state of the double pendulum system
     *
