 ...
 * 常用于天气预报、数据同化和混沌理论研究。 / The Lorenz 96 model is an N-dimensional chaotic system proposed by Edward Lorenz in 1996.
 ...
 *
 * 基于 Lorenz96Model 的状态生成器，每次调用时推进一个时间步并返回前一步的状态。 / A state generator based on Lorenz96Model that advances one time step per invocation and returns the previous state.
 *
