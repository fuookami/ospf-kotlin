...
class FactorizationTest {
    ...
    @Test
    fun factorizeBoundary() {
        assertEquals(emptyList<Pair<UInt64, Int>>(), factorize(UInt64(0), UInt64))
        assertEquals(emptyList<Pair<UInt64, Int>>(), factorize(UInt64(1), UInt64))
    }
    ...
    @Test
    fun divisorsBoundary() {
        assertEquals(listOf(UInt64.one), divisors(UInt64(1), UInt64))
    }
    ...
    @Test
    fun divisorCountBoundary() {
        assertEquals(1, divisorCount(UInt64(1), UInt64))
    }
    ...
    @Test
    fun eulerTotientBoundary() {
        assertEquals(UInt64(0), eulerTotient(UInt64(0), UInt64))
        assertEquals(UInt64(1), eulerTotient(UInt64(1), UInt64))
    }
}
