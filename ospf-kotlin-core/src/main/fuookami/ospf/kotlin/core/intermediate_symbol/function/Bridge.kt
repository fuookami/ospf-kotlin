...
fun LinearIntermediateSymbolFlt64.asMathLinearPolynomial(): MathLinearPolynomial<Flt64> {
    return (this as LinearIntermediateSymbolFlt64).toMathLinearPolynomial()
}
