...
@Deprecated(
    message = "Use intermediate_symbol.function.RoundingFunction instead. The linear version handles quadratic inputs.",
    replaceWith = ReplaceWith("RoundingFunction", "fuookami.ospf.kotlin.core.intermediate_symbol.function.RoundingFunction")
)
