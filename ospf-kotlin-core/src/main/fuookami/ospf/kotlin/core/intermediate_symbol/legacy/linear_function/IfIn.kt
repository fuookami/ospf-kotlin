...
@Deprecated(
    message = "Use intermediate_symbol.function.IfInFunction instead",
    replaceWith = ReplaceWith("IfInFunction", "fuookami.ospf.kotlin.core.intermediate_symbol.function.IfInFunction")
)
class IfInFunction(
