...
@Deprecated(
    message = "Use intermediate_symbol.function.AbsFunction instead",
    replaceWith = ReplaceWith("AbsFunction", "fuookami.ospf.kotlin.core.intermediate_symbol.function.AbsFunction")
)
class AbsFunction(
