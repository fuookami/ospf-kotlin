...
typealias OriginQuadraticConstraint = fuookami.ospf.kotlin.core.intermediate_model.QuadraticConstraint
...
) : ModelConstraint<QuadraticConstraintCell>(lhs, signs, rhs, names, sources) {
