...
typealias OriginLinearConstraint = fuookami.ospf.kotlin.core.intermediate_model.LinearConstraint
...
) : ModelConstraint<LinearConstraintCell>(lhs, signs, rhs, names, sources) {
