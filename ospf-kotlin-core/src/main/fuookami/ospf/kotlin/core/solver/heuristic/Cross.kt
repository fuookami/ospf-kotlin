/**
 * 启发式交叉操作接口 / Heuristic crossover operation interface
*/
...
/**
 * 交叉操作接口，定义从父代个体生成子代解的行为。 / Crossover operation interface, defining behavior for generating offspring solutions from parent individuals.
 *
...
interface Cross<V> where V : RealNumber<V>, V : NumberField<V> {
    ...
    /**
     * 从父代个体执行交叉操作生成子代解。 / Perform crossover from parent individuals to generate offspring solutions.
     *
