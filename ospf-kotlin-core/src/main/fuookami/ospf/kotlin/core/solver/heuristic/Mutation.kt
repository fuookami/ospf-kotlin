/**
 * 启发式变异操作接口 / Heuristic mutation operation interface
*/
...
/**
 * 变异操作接口，定义对个体进行变异生成新解的行为。 / Mutation operation interface, defining behavior for mutating individuals to generate new solutions.
 *
...
interface Mutation<V> where V : RealNumber<V>, V : NumberField<V> {
    ...
    /**
     * 对个体执行变异操作生成新解。 / Perform mutation on an individual to generate a new solution.
     *
