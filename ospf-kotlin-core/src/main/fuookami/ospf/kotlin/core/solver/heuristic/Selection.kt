...
abstract class LocalSelection : Selection {
    ...
    protected abstract val randomGenerator: Generator<F64>

    protected abstract fun getNeighbours(weights: List<F64>, amount: UInt64): Set<UInt64>
...
data class RingLocalSelection(
    ...
    override val randomGenerator: Generator<F64>
) : LocalSelection() {
    companion object {
        operator fun invoke(
    ...
    override fun getNeighbours(weights: List<F64>, amount: UInt64): Set<UInt64> {
