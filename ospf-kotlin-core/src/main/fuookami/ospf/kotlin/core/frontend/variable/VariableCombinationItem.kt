...
class DynBinVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<UInt8, Binary>(Binary, name, UInt8, shape)
...
class DynTerVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<UInt8, Ternary>(Ternary, name, UInt8, shape)
...
class BTerVariable1(name: String = "", shape: Shape1) :
    VariableCombination1<Int8, BalancedTernary>(BalancedTernary, name, Int8, shape)

class BTerVariable2(name: String = "", shape: Shape2) :
    VariableCombination2<Int8, BalancedTernary>(BalancedTernary, name, Int8, shape)

class BTerVariable3(name: String = "", shape: Shape3) :
    VariableCombination3<Int8, BalancedTernary>(BalancedTernary, name, Int8, shape)

class BTerVariable4(name: String = "", shape: Shape4) :
    VariableCombination4<Int8, BalancedTernary>(BalancedTernary, name, Int8, shape)

class DynBTerVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<Int8, BalancedTernary>(BalancedTernary, name, Int8, shape)
...
class PctVariable1(name: String = "", shape: Shape1) :
    VariableCombination1<Flt64, Percentage>(Percentage, name, Flt64, shape)

class PctVariable2(name: String = "", shape: Shape2) :
    VariableCombination2<Flt64, Percentage>(Percentage, name, Flt64, shape)

class PctVariable3(name: String = "", shape: Shape3) :
    VariableCombination3<Flt64, Percentage>(Percentage, name, Flt64, shape)

class PctVariable4(name: String = "", shape: Shape4) :
    VariableCombination4<Flt64, Percentage>(Percentage, name, Flt64, shape)

class DynPctVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<Flt64, Percentage>(Percentage, name, Flt64, shape)
...
class DynIntVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<Int64, Integer>(Integer, name, Int64, shape)
...
class UIntVariable1(name: String = "", shape: Shape1) :
    VariableCombination1<UInt64, UInteger>(UInteger, name, UInt64, shape)

class UIntVariable2(name: String = "", shape: Shape2) :
    VariableCombination2<UInt64, UInteger>(UInteger, name, UInt64, shape)

class UIntVariable3(name: String = "", shape: Shape3) :
    VariableCombination3<UInt64, UInteger>(UInteger, name, UInt64, shape)

class UIntVariable4(name: String = "", shape: Shape4) :
    VariableCombination4<UInt64, UInteger>(UInteger, name, UInt64, shape)

class DynUIntVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<UInt64, UInteger>(UInteger, name, UInt64, shape)
...
class RealVariable1(name: String = "", shape: Shape1) :
    VariableCombination1<Flt64, Continuous>(Continuous, name, Flt64, shape)

class RealVariable2(name: String = "", shape: Shape2) :
    VariableCombination2<Flt64, Continuous>(Continuous, name, Flt64, shape)

class RealVariable3(name: String = "", shape: Shape3) :
    VariableCombination3<Flt64, Continuous>(Continuous, name, Flt64, shape)

class RealVariable4(name: String = "", shape: Shape4) :
    VariableCombination4<Flt64, Continuous>(Continuous, name, Flt64, shape)

class DynRealVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<Flt64, Continuous>(Continuous, name, Flt64, shape)
...
class URealVariable1(name: String = "", shape: Shape1) :
    VariableCombination1<Flt64, UContinuous>(UContinuous, name, Flt64, shape)

class URealVariable2(name: String = "", shape: Shape2) :
    VariableCombination2<Flt64, UContinuous>(UContinuous, name, Flt64, shape)

class URealVariable3(name: String = "", shape: Shape3) :
    VariableCombination3<Flt64, UContinuous>(UContinuous, name, Flt64, shape)

class URealVariable4(name: String = "", shape: Shape4) :
    VariableCombination4<Flt64, UContinuous>(UContinuous, name, Flt64, shape)

class DynURealVariable(name: String = "", shape: DynShape) :
    DynVariableCombination<Flt64, UContinuous>(UContinuous, name, Flt64, shape)
