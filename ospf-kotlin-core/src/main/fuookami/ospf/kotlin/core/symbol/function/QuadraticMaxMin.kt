...
/**
 * 用于最大化最小值的精确函数 / Exact minimum for max-min objectives.
 *
...
class QuadraticMaxMinFunction<V>(
    ...
    override fun createFunction(inputs: List<LinearPolynomial<V>>): MathFunctionSymbol<V> = MaxMinFunction(
