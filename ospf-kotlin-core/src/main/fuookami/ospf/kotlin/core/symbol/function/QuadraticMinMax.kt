...
/**
 * 用于最小化最大值的精确函数 / Exact maximum for min-max objectives.
 *
...
class QuadraticMinMaxFunction<V>(
    ...
    override fun createFunction(inputs: List<LinearPolynomial<V>>): MathFunctionSymbol<V> = MinMaxFunction(
