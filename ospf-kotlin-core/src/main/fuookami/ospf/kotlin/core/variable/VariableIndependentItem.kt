/**
 * 独立变量项（非组合），支持各数值类型的标量变量及其物理单位扩展。 / Independent variable items (non-combination), supporting scalar variables for all numeric types and their physical unit extensions.
*/
...
/**
 * 独立变量项的密封基类，维度为 0，标识符由 IdentifierGenerator 生成。 / Sealed base class for independent variable items with dimension 0 and identifier generated by IdentifierGenerator.
 *
