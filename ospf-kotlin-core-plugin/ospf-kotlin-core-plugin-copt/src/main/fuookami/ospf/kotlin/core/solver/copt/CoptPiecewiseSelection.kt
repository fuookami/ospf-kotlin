 ...
 * Select PWL structures that can safely be delegated to COPT SOS2 before indexing.
 */
internal fun selectCoptNativePiecewise(
    ...
    return model.deferredFunctionStructures
        ...
        .filter { structure ->
            ...
            val data = when (val prepared = prepareCoptNativePiecewise(structure)) {
