/** Gurobi 11 约束符号映射 / Gurobi 11 constraint sign mapping */
package fuookami.ospf.kotlin.core.solver.gurobi11

import com.gurobi.gurobi.GRB
import fuookami.ospf.kotlin.core.model.basic.ConstraintRelation

/** Gurobi 11 约束符号枚举，将内部约束关系映射为 Gurobi 约束符号 / Gurobi 11 constraint sign enum, maps internal constraint relations to Gurobi constraint signs */
