    ...
    private suspend fun dump(model: LinearTriadModelView): Try {
        return try {
            ...
            for ((col, variable) in model.variables.withIndex()) {
                lowerBounds[col] = variable.lowerBound.toSolverDouble("linear.variables[$col].lowerBound")
                upperBounds[col] = variable.upperBound.toSolverDouble("linear.variables[$col].upperBound")
