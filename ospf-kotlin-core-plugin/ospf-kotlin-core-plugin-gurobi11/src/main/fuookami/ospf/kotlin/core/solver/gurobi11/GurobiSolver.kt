...
abstract class GurobiSolver : AutoCloseable {
    ...
    /**
     * 使用远程服务器初始化 Gurobi 11 环境和模型 / Initialize Gurobi 11 environment and model using remote server
     *
    ...
    /**
     * 使用本地环境初始化 Gurobi 11 模型 / Initialize Gurobi 11 model using local environment
     *
     * @param name 模型名称 / model name
     * @param callBack 创建环境回调函数 / creating environment callback function
     * @return 操作结果 / operation result
