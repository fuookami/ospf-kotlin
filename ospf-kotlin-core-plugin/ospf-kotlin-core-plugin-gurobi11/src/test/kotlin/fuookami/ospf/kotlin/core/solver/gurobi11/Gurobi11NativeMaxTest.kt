...
/** Gurobi 11 MAX primitive/writer 定向测试。 / Focused Gurobi 11 MAX primitive/writer tests. */
class Gurobi11NativeMaxTest {
    private val input = RealVar("gurobi11_max_input")
    private val result = RealVar("gurobi11_max_result")
    private val selectors = listOf(
        BinVar("gurobi11_max_selector_0"),
        BinVar("gurobi11_max_selector_1"),
        BinVar("gurobi11_max_selector_2")
    )
    ...
    private fun structure(
        ...
        name: String = "gurobi11-native-max"
    ): MaxStructure<Flt64> {
        return MaxStructure(
            inputs = listOf(
                LinearPolynomial(
