/**
 * 本文件定义应用程序中使用的所有错误码枚举。 / This file defines all error code enumerations used throughout the application.
*/
package fuookami.ospf.kotlin.utils.error

/**
 * 错误码枚举 / Enumeration of error codes used throughout the application.
 * Each error code is a unique UByte value.
 *
 * UTL-007: 修复重复的错误码值 / UTL-007: Fixed duplicate error code values.
 *
...
enum class ErrorCode(private val code: UByte) {
    ...
    */
    ...
    /**
     * 唯一值容器已锁定 / Unique box locked.
    */
    UniqueBoxLocked(0x18U),

    /**
     * 唯一引用已锁定 / Unique reference locked.
    */
    ...
    */
    ...
    /**
     * OR 引擎环境丢失 / OR engine environment lost.
    */
    OREngineEnvironmentLost(0x24U),

    /**
     * OR 引擎连接超时 / OR engine connection overtime.
    */
    OREngineConnectionOvertime(0x25U),

    /**
     * OR 引擎建模异常 / OR engine modeling exception.
    */
    OREngineModelingException(0x26U),

    /**
     * OR 引擎求解异常 / OR engine solving exception.
    */
    OREngineSolvingException(0x27U),

    /**
     * OR 引擎已终止 / OR engine terminated.
    */
    OREngineTerminated(0x28U),

    /**
     * OR 模型不可行 / OR model infeasible.
    */
    ORModelInfeasible(0x29U),

    /**
     * OR 模型无界 / OR model unbounded.
    */
    ORModelUnbounded(0x2aU),

    /**
     * OR 模型不可行或无界 / OR model infeasible or unbounded.
     *
    ...
    */
    ...
    /**
     * OR 解无效 / OR solution invalid.
     *
     * 原值 0x2cU 保持不变 / Original value 0x2cU unchanged.
    */
    ...
    */
    ...
    companion object {
         ...
         *
         * UTL-007: 增强健壮性，未知 code 返回 Unknown 而不是抛出异常 / UTL-007: Enhanced robustness, returns Unknown for unknown codes instead of throwing exception.
         *
    ...
    */
    ...
    /**
     * 返回错误码名称 / Returns the name of this error code.
     *
