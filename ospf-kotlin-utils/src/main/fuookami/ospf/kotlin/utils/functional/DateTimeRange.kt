/**
 * 日期范围迭代器 / Iterator utilities for LocalDate ranges with configurable step periods.
...
/**
 * 闭区间日期迭代器 / Iterator for closed ranges of LocalDate with a specified step period.
...
class LocalDateClosedRangeIterator(
    ...
    /**
     * 检查是否有下一个日期 / Checks if there is another date within the range.
     * 检查范围内是否有下一个日期。
     *
    ...
    */
    ...
    /**
     * 获取下一个日期并推进迭代器 / Returns the next date and advances the iterator by the step period.
     * 返回下一个日期并按步进周期推进迭代器。
     *
...
/**
 * 创建闭区间日期范围的迭代器 / Creates an iterator for a closed range of LocalDate with the specified step period.
...
/**
 * 开区间日期迭代器 / Iterator for open-ended ranges of LocalDate with a specified step period.
...
class LocalDateOpenEndRangeIterator(
    ...
    /**
     * 检查是否有下一个日期 / Checks if there is another date within the range (exclusive end).
...
/**
 * 创建开区间日期范围的迭代器 / Creates an iterator for an open-ended range of LocalDate with the specified step period.
