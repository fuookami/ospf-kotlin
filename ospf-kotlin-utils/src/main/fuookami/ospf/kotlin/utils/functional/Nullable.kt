/**
 * 空值处理扩展 / Extension functions for nullable value handling.
 * 可空值处理的扩展函数。
*/
package fuookami.ospf.kotlin.utils.functional

/**
 * 如果为空则使用默认值 / Returns the value if non-null, otherwise returns the result of the default provider.
...
/**
 * 如果集合为空或 null 则使用默认集合 / Returns the collection if non-null and non-empty, otherwise returns the default collection.
...
/**
 * 如果集合为空或 null 则使用默认值提供者 / Returns the collection if non-null and non-empty, otherwise returns the result of the default provider.
