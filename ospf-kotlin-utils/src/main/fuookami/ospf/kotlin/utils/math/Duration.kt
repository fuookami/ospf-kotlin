...
fun Int32.times(duration: Duration) = this.toFlt64().times(duration)
fun UInt32.times(duration: Duration) = this.toFlt64().times(duration)
fun Int64.times(duration: Duration) = this.toFlt64().times(duration)
fun UInt64.times(duration: Duration) = this.toFlt64().times(duration)
fun IntX.times(duration: Duration) = this.toFlt64().times(duration)
fun UIntX.times(duration: Duration) = this.toFlt64().times(duration)
fun Flt32.times(duration: Duration) = this.toFlt64().times(duration)
fun Flt64.times(duration: Duration) = this.toDouble().times(duration)
fun FltX.times(duration: Duration) = this.toFlt64().times(duration)

fun Duration.div(value: Int32) = this.div(value.toFlt64())
fun Duration.div(value: UInt32) = this.div(value.toFlt64())
fun Duration.div(value: Int64) = this.div(value.toFlt64())
fun Duration.div(value: UInt64) = this.div(value.toFlt64())
fun Duration.div(value: IntX) = this.div(value.toFlt64())
fun Duration.div(value: UIntX) = this.div(value.toFlt64())
fun Duration.div(value: Flt32) = this.div(value.toFlt64())
fun Duration.div(value: Flt64) = this.div(value.toDouble())
fun Duration.div(value: FltX) = this.div(value.toFlt64())
