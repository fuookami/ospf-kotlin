 ...
 *
 * 由位置坐标和投影形状定义的二维放置，支持包含测试、重叠检测和求交运算。 / A 2D placement defined by position coordinates and a projection shape, supporting containment tests, overlap detection, and intersection.
*/
...
data class QuantityPlacement2<V : FloatingNumber<V>>(
    ...
    */
    fun intersect(rhs: QuantityPlacement2<V>): Ret<QuantityPlacement2<V>?> {
        ...
        } ?: return ok<QuantityPlacement2<V>?>(null)
        return ok(QuantityPlacement2(
            x = intersection.x,
            y = intersection.y,
