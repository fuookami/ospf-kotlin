/**
 * 二维投影形状 / 2D projection shapes
 *
 * 定义二维投影形状（圆形、矩形），支持面积计算和轴置换。 / Defines 2D projection shapes (circle, rectangle), supporting area calculation and axis permutation.
*/
 ...
 *
 * 所有二维投影形状（圆形、矩形）的公共密封接口。 / Common sealed interface for all 2D projection shapes (circle, rectangle).
 *
...
/**
 * 二维形状类型别名 / Type alias for 2D shape
*/
...
data class QuantityRectangle2<V : FloatingNumber<V>>(
    ...
    */
    ...
    /**
     * 对矩形应用轴置换 / Apply axis permutation to the rectangle
     *
