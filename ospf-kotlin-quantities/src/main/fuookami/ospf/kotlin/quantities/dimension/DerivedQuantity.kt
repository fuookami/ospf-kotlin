 ...
 *
 * 由基础量纲的幂次组成，如 L²·M·T⁻²。导出量纲表示由基本物理量组合而成的复合物理量纲。 / Composed of powers of fundamental dimensions, such as L²·M·T⁻². Derived quantities represent composite physical dimensions formed by combining fundamental physical quantities.
*/
 ...
 * 导出量纲类 / Derived quantity class
 *
 * 由基础量纲的幂次组成，如 L^2*M*T^-2。 / Composed of powers of fundamental dimensions, such as L^2*M*T^-2.
 *
...
class DerivedQuantity(
    ...
    /**
     * 排序后的量纲列表 / Sorted list of quantities
    */
    val quantities = quantities.sortedBy { it.dimension.symbol }

    /**
     * 从基础量纲构造导出量纲 / Constructs a derived quantity from a fundamental dimension
     *
    ...
    */
    ...
    /**
     * 从基础量纲值构造导出量纲 / Constructs a derived quantity from a fundamental quantity value
     *
    ...
    */
    ...
    /**
     * 从另一个导出量纲构造新的导出量纲 / Constructs a new derived quantity from another derived quantity
     *
    ...
    */
    ...
    /**
     * 取负（所有幂次取反） / Negation operator (inverts all powers)
     *
    ...
    */
    ...
    /**
     * 获取指定量纲的幂次 / Gets the power of a specified dimension
     *
    ...
    */
    ...
    /**
     * 添加量纲幂次 / Adds power to a dimension
     *
    ...
    */
    ...
    /**
     * 检查是否为无量纲 / Checks if this is a dimensionless quantity
     *
    ...
    */
    ...
    /**
     * 获取量纲符号表示 / Gets the dimension symbol representation
     *
    ...
    */
    ...
    /**
     * 倒数 / Reciprocal (inverse) of the quantity
     *
...
/**
 * 无量纲常量 / Dimensionless constant
*/
val DimLess = DerivedQuantity(emptyList(), "Dimensionless", "1")

/**
 * 两个基础量纲值相乘 / Multiplies two fundamental quantities
 *
...
/**
 * 两个基础量纲值相除 / Divides two fundamental quantities
 *
...
/**
 * 基础量纲值与导出量纲相乘 / Multiplies a fundamental quantity by a derived quantity
 *
...
/**
 * 基础量纲值除以导出量纲 / Divides a fundamental quantity by a derived quantity
 *
...
/**
 * 导出量纲乘以整数 / Multiplies a derived quantity by an integer
 *
...
/**
 * 导出量纲除以整数 / Divides a derived quantity by an integer
 *
...
/**
 * 导出量纲乘以基础量纲值 / Multiplies a derived quantity by a fundamental quantity
 *
...
/**
 * 导出量纲除以基础量纲值 / Divides a derived quantity by a fundamental quantity
 *
...
/**
 * 两个导出量纲相乘 / Multiplies two derived quantities
 *
...
/**
 * 两个导出量纲相除 / Divides two derived quantities
 *
