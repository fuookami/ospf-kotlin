 ...
 *
 * 提供角速度量纲的 SI 单位定义，包括弧度每秒、度每秒等。 / Provides SI unit definitions for angular velocity dimension, including radian per second,
...
/**
 * 弧度每秒（SI 导出单位） / Radian per second (SI derived unit)
 *
 * 名称：弧度每秒 / Name: radian per second
 *
 * 符号：rad/s
 * Symbol: rad/s
 *
 ...
 *
 * 来源：SI 导出单位，角速度的国际单位 / Source: SI derived unit, international unit for angular velocity
*/
...
/**
 * 度每秒 / Degree per second
 *
 * 名称：度每秒 / Name: degree per second
 *
 * 符号：°/s / Symbol: °/s
 *
 ...
 *
 * 来源：常用角速度单位，广泛用于工程和导航 / Source: Common angular velocity unit, widely used in engineering and navigation
*/
