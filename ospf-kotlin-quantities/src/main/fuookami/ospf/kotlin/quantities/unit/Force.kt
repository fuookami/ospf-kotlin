 ...
 * 力单位 / Force units
 *
 * 提供力量纲的 SI 单位和英制单位定义，包括牛顿、千克力、达因、磅力等。 / Provides SI and imperial unit definitions for force dimension, including newton, kilogram-force, dyne, pound-force, etc.
 *
 ...
 * 牛顿 / Newton
 *
 * 力的 SI 导出单位。 / SI derived unit for force.
 *
 * 定义：1 N = 1 kg × 1 m/s²
 ...
 * 千牛 / Kilonewton
 *
 * 一千牛顿，常用于结构工程。 / One thousand newtons, commonly used in structural engineering.
 *
 * 定义：1 kN = 10³ N / Definition: 1 kN = 10³ N
*/
 ...
 * 兆牛 / Meganewton
 *
 * 一百万牛顿，常用于大型结构工程。 / One million newtons, commonly used in large structural engineering.
 *
 * 定义：1 MN = 10⁶ N / Definition: 1 MN = 10⁶ N
*/
 ...
 * 千克力 / Kilogram-force
 *
 * 重力单位，表示 1 千克物体在标准重力加速度下受到的重力。 / Gravitational unit, representing the force on 1 kg under standard gravity.
 *
 ...
 * 达因 / Dyne
 *
 * CGS 单位制中的力单位。 / Force unit in the CGS system.
 *
