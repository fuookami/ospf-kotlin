 ...
 *
 * 提供流量量纲的单位定义，包括立方米每秒、升每秒等。 / Provides unit definitions for flow rate dimension, including cubic meter per second, liter per second, etc.
*/
...
/**
 * 立方米每秒 / Cubic meter per second
 *
 * 流量的 SI 导出单位。 / SI derived unit for flow rate.
 *
 * 定义：1 m³/s = 1 m³ / 1 s
