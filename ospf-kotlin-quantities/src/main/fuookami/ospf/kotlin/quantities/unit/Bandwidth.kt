 ...
 *
 * 提供带宽度纲的单位定义，包括比特每秒、千比特每秒、兆比特每秒等。 / Provides unit definitions for bandwidth dimension, including bit per second, kilobit per second, megabit per second, etc.
*/
 ...
 * 比特每秒 / Bit per second
 *
 * 带宽基本单位。 / Base unit for bandwidth.
 *
 * 定义：1 bit/s = 1 比特 / 秒 / Definition: 1 bit/s = 1 bit / second
*/
