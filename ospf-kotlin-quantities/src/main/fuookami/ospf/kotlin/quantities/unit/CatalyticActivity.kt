 ...
 *
 * 提供催化活度量纲的 SI 单位定义，包括开特、毫开特、微开特、酶单位等。 / Provides SI unit definitions for catalytic activity dimension, including katal, millikatal,
...
/**
 * 开特（SI 导出单位） / Katal (SI derived unit)
 *
 * 名称：开特 / Name: katal
 *
 * 符号：kat / Symbol: kat
 ...
 * 于 1999 年第 21 届国际计量大会采纳 / Source: SI derived unit, international unit for catalytic activity
 ...
 *
 * 来源：SI 催化活度单位 / Source: SI catalytic activity unit
*/
 ...
 *
 * 来源：SI 催化活度单位，常用于酶学 / Source: SI catalytic activity unit, commonly used in enzymology
*/
 ...
 *
 * 来源：生化领域常用单位，定义酶催化反应速率 / 1 U ≈ 16.67 nkat
