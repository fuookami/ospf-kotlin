 ...
 * 美制液体盎司、英制加仑、美制加仑等。 / Provides unit definitions for volume dimension, including cubic meter, liter, milliliter, cubic inch,
 * cubic foot, cubic yard, UK fluid ounce, US fluid ounce, UK gallon, US gallon, etc.
 *
 * 来源：SI 导出单位及常用体积单位定义 / Source: SI derived units and common volume unit definitions
 ...
 *
 * 来源：SI 导出体积单位 / Source: SI derived volume unit
*/
 ...
 *
 * 来源：SI 导出体积单位，常用于医学和化学 / Source: SI derived volume unit, commonly used in medicine and chemistry
*/
...
/**
 * 立方米（SI 导出单位） / Cubic meter (SI derived unit)
 *
 * 名称：立方米 / Name: cubic meter
 *
 * 符号：m³ / Symbol: m³
 *
 * 定义：1 m³ = (1 m)³ / Definition: 1 m³ = (1 m)³
 *
 * 来源：SI 导出单位，体积的国际单位 / Source: SI derived unit, international unit for volume
*/
...
/**
 * 立方十米 / Cubic decameter
 *
 * 名称：立方十米 / Name: cubic decameter
 *
 * 符号：dam³ / Symbol: dam³
 *
 * 定义：1 dam³ = (1 dam)³ = 10³ m³
 ...
 *
 * 来源：SI 导出体积单位，常用于水资源计量 / Source: SI derived volume unit, commonly used for water resource measurement
*/
...
/**
 * 立方百米 / Cubic hectometer
 *
 * 名称：立方百米 / Name: cubic hectometer
 *
 * 符号：hm³ / Symbol: hm³
 *
 * 定义：1 hm³ = (1 hm)³ = 10⁶ m³
 ...
 *
 * 来源：SI 导出体积单位，常用于水库库容计量 / Source: SI derived volume unit, commonly used for reservoir capacity measurement
*/
...
/**
 * 立方千米 / Cubic kilometer
 *
 * 名称：立方千米 / Name: cubic kilometer
 *
 * 符号：km³ / Symbol: km³
 *
 * 定义：1 km³ = (1 km)³ = 10⁹ m³
 ...
 *
 * 来源：SI 导出体积单位，常用于地质和海洋体积计量 / Source: SI derived volume unit, commonly used for geological and oceanic volume measurement
*/
 ...
 * 符号：L / Symbol: L
 *
 * 定义：1 L = 1 dm³ = 10⁻³ m³（精确，1964 年 CGPM） / Definition: 1 L = 1 dm³ = 10⁻³ m³ (exact, 1964 CGPM)
 *
 * 来源：常用体积单位，广泛用于日常生活和科学 / Source: Common volume unit, widely used in daily life and science
*/
 ...
 * 微升 / Microliter
 *
 * 名称：微升 / Name: microliter
 *
 * 符号：μL / Symbol: μL
 *
 * 定义：1 μL = 10⁻⁶ L / Definition: 1 μL = 10⁻⁶ L
 *
 * 来源：SI 体积单位，常用于实验室微量分析 / Source: SI volume unit, commonly used in laboratory microanalysis
*/
 ...
 *
 * 来源：SI 体积单位，广泛用于医学和日常生活 / Source: SI volume unit, widely used in medicine and daily life
*/
 ...
 * 厘升 / Centiliter
 *
 * 名称：厘升 / Name: centiliter
 *
 * 符号：cL / Symbol: cL
 *
 * 定义：1 cL = 10⁻² L / Definition: 1 cL = 10⁻² L
 *
 * 来源：SI 体积单位 / Source: SI volume unit
*/
 ...
 * 分升 / Deciliter
 *
 * 名称：分升 / Name: deciliter
 *
 * 符号：dL / Symbol: dL
 *
 * 定义：1 dL = 10⁻¹ L / Definition: 1 dL = 10⁻¹ L
 *
 * 来源：SI 体积单位，常用于医学检验 / Source: SI volume unit, commonly used in medical tests
*/
 ...
 * 百升 / Hectoliter
 *
 * 名称：百升 / Name: hectoliter
 *
 * 符号：hL / Symbol: hL
 *
 * 定义：1 hL = 10² L / Definition: 1 hL = 10² L
 *
 * 来源：SI 体积单位，常用于酿造业和农业 / Source: SI volume unit, commonly used in brewing and agriculture
*/
 ...
 *
 * 来源：英制体积单位 / Source: Imperial volume unit
*/
 ...
 *
 * 来源：英制体积单位，常用于建筑和工程 / Source: Imperial volume unit, commonly used in construction and engineering
*/
 ...
 *
 * 来源：英制体积单位，常用于建筑材料 / Source: Imperial volume unit, commonly used for construction materials
*/
...
/**
 * 英制液体盎司 / UK fluid ounce
 *
 * 名称：英制液体盎司 / Name: UK fluid ounce
 *
 * 符号：uk.fl.oz
 * Symbol: uk.fl.oz
 *
 * 定义：1 UK fl oz = 28.4130625 mL（精确，《度量衡法》1985） / Definition: 1 UK fl oz = 28.4130625 mL (exact, Weights and Measures Act 1985)
 *
 * 来源：英制体积单位 / Source: Imperial volume unit
*/
...
/**
 * 美制液体盎司 / US fluid ounce
 *
 * 名称：美制液体盎司 / Name: US fluid ounce
 *
 * 符号：us.fl.oz
 * Symbol: us.fl.oz
 *
 * 定义：1 US fl oz = 29.5735295625 mL（精确，1 美制加仑 = 128 美制液体盎司） / Definition: 1 US fl oz = 29.5735295625 mL (exact, 1 US gallon = 128 US fl oz)
 *
 * 来源：美制体积单位 / Source: US customary volume unit
*/
 ...
 * 英制加仑 / UK gallon
 *
 * 名称：英制加仑 / Name: UK gallon
 *
 * 符号：uk.gal
 * Symbol: uk.gal
 *
 * 定义：1 UK gal = 4.54609 L（精确，《度量衡法》1985） / Definition: 1 UK gal = 4.54609 L (exact, Weights and Measures Act 1985)
 *
 * 来源：英制体积单位 / Source: Imperial volume unit
*/
 ...
 * 美制加仑 / US gallon
 *
 * 名称：美制加仑 / Name: US gallon
 *
 * 符号：us.gal
 * Symbol: us.gal
 *
 * 定义：1 US gal = 3.78541178 L（精确，NIST 手册 44） / Definition: 1 US gal = 3.78541178 L (exact, NIST Handbook 44)
 *
 * 来源：美制体积单位，常用于美国燃油销售 / Source: US customary volume unit, commonly used for fuel sales in the US
*/
