 ...
 * 时间单位 / Time units
 *
 * 提供时间量纲的单位定义，包括秒、毫秒、微秒、纳秒、分、时、天、周、年等。 / Provides unit definitions for time dimension, including second, millisecond, microsecond, nanosecond,
 * minute, hour, day, week, year, etc.
 *
 * 来源：SI 基本单位及常用时间单位定义 / Source: SI base unit and common time unit definitions
...
/**
 * 秒（SI 基本单位） / Second (SI base unit)
 *
 * 名称：秒 / Name: second
 *
 * 符号：s / Symbol: s
 *
 * 定义：铯-133 原子基态两个超精细能级之间跃迁所对应辐射的 9,192,631,770 个周期持续的时间 / Definition: Duration of 9,192,631,770 periods of the radiation corresponding to the transition
 * between the two hyperfine levels of the ground state of the caesium-133 atom
 *
 * 来源：SI 七个基本单位之一 / Source: One of the seven SI base units
*/
 ...
 * 纳秒 / Nanosecond
 *
 * 名称：纳秒 / Name: nanosecond
 *
 * 符号：ns / Symbol: ns
 *
 * 定义：1 ns = 10⁻⁹ s / Definition: 1 ns = 10⁻⁹ s
 *
 * 来源：SI 时间单位，常用于计算机科学和高精度计时 / Source: SI time unit, commonly used in computer science and high-precision timing
*/
 ...
 * 微秒 / Microsecond
 *
 * 名称：微秒 / Name: microsecond
 *
 * 符号：μs / Symbol: μs
 *
 * 定义：1 μs = 10⁻⁶ s / Definition: 1 μs = 10⁻⁶ s
 *
 * 来源：SI 时间单位，常用于科学实验和工程测量 / Source: SI time unit, commonly used in scientific experiments and engineering measurements
*/
 ...
 * 毫秒 / Millisecond
 *
 * 名称：毫秒 / Name: millisecond
 *
 * 符号：ms / Symbol: ms
 *
 * 定义：1 ms = 10⁻³ s / Definition: 1 ms = 10⁻³ s
 *
 * 来源：SI 时间单位，常用于日常计时和计算机编程 / Source: SI time unit, commonly used in daily timing and computer programming
*/
 ...
 *
 * 来源：常用时间单位 / Source: Common time unit
*/
 ...
 * 符号：d / Symbol: d
 *
 * 定义：1 d = 24 h = 86400 s / Definition: 1 d = 24 h = 86400 s
 *
 * 来源：常用时间单位，基于地球自转周期 / Source: Common time unit, based on Earth's rotation period
*/
 ...
 *
 * 来源：儒略年，常用于天文学和科学计算 / Source: Julian year, commonly used in astronomy and scientific calculations
*/
