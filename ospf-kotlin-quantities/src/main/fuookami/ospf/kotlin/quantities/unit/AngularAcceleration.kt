 ...
 *
 * 提供角加速度量纲的 SI 单位定义，包括弧度每二次方秒、度每二次方秒等。 / Provides SI unit definitions for angular acceleration dimension, including radian per second squared,
...
/**
 * 弧度每二次方秒（SI 导出单位） / Radian per second squared (SI derived unit)
 *
 * 名称：弧度每二次方秒 / Name: radian per second squared
 *
 * 符号：rad/s²
 * Symbol: rad/s²
 *
 ...
 *
 * 来源：SI 导出单位，角加速度的国际单位 / Source: SI derived unit, international unit for angular acceleration
*/
...
/**
 * 度每二次方秒 / Degree per second squared
 *
 * 名称：度每二次方秒 / Name: degree per second squared
 *
 * 符号：°/s² / Symbol: °/s²
 *
 ...
 *
 * 来源：常用角加速度单位，广泛用于工程和导航 / Source: Common angular acceleration unit, widely used in engineering and navigation
*/
