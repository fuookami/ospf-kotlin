 ...
 *
 * 提供电流量纲的 SI 单位定义，包括安培、毫安、微安、千安等。 / Provides SI unit definitions for electric current dimension, including ampere, milliampere, microampere, kiloampere, etc.
*/
...
/**
 * 安培（基本单位） / Ampere (base unit)
 *
 * SI 基本单位，用于表示电流。 / SI base unit for electric current.
 *
 * 定义：安培是恒定电流，若保持在真空中相距 1 米的两无限长平行直导线内，
 * 则两导线之间产生的力在每米长度上等于 2×10⁻⁷ 牛顿。 / Definition: The ampere is that constant current which, if maintained in two
 ...
 * 毫安 / Milliampere
 *
 * 定义：1 mA = 10⁻³ A / Definition: 1 mA = 10⁻³ A
*/
 ...
 * 微安 / Microampere
 *
 * 定义：1 µA = 10⁻⁶ A / Definition: 1 µA = 10⁻⁶ A
*/
 ...
 * 千安 / Kiloampere
 *
 * 定义：1 kA = 10³ A / Definition: 1 kA = 10³ A
*/
