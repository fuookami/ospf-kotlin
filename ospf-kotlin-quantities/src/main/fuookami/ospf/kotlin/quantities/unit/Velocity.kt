 ...
 * 英寸每秒、英尺每秒、英里每小时等。 / Provides unit definitions for velocity dimension, including meter per second, centimeter per second,
 * kilometer per second, kilometer per hour, mach, knot, light speed, inch per second, foot per second,
 * mile per hour, etc.
 *
 * 来源：SI 导出单位及常用速度单位定义 / Source: SI derived units and common velocity unit definitions
...
/**
 * 厘米每秒 / Centimeter per second
 *
 * 名称：厘米每秒 / Name: centimeter per second
 *
 * 符号：cm/s / Symbol: cm/s
 *
 ...
 *
 * 来源：SI 导出速度单位 / Source: SI derived velocity unit
*/
...
/**
 * 米每秒（SI 导出单位） / Meter per second (SI derived unit)
 *
 * 名称：米每秒 / Name: meter per second
 *
 * 符号：m/s / Symbol: m/s
 *
 * 定义：1 m/s = 1 m / 1 s
 ...
 *
 * 来源：SI 导出单位，速度的国际单位 / Source: SI derived unit, international unit for velocity
*/
...
/**
 * 千米每秒 / Kilometer per second
 *
 * 名称：千米每秒 / Name: kilometer per second
 *
 * 符号：km/s / Symbol: km/s
 *
 ...
 *
 * 来源：SI 导出速度单位，常用于航天和天文学 / Source: SI derived velocity unit, commonly used in aerospace and astronomy
*/
...
/**
 * 千米每小时 / Kilometer per hour
 *
 * 名称：千米每小时 / Name: kilometer per hour
 *
 * 符号：km/h / Symbol: km/h
 *
 ...
 *
 * 来源：常用速度单位，广泛用于车辆速度表示 / Source: Common velocity unit, widely used for vehicle speed representation
*/
 ...
 * 符号：Ma / Symbol: Ma
 *
 * 定义：1 Ma ≈ 340.3 m/s（海平面标准大气压下的音速） / Definition: 1 Ma ≈ 340.3 m/s (speed of sound at sea level standard atmospheric pressure)
 *
 * 来源：航空领域常用单位，以恩斯特·马赫命名 / Source: Common unit in aviation, named after Ernst Mach
*/
...
/**
 * 节（国际海里） / Knot (International nautical mile)
 *
 * 名称：节 / Name: knot
 *
 * 符号：kn / Symbol: kn
 *
 * 定义：1 kn = 1 海里 / 1 小时 ≈ 0.514444 m/s / Definition: 1 kn = 1 nautical mile / 1 hour ≈ 0.514444 m/s
 *
 * 来源：航海和航空领域常用速度单位 / Source: Common velocity unit in maritime and aviation
*/
 ...
 * 法国节 / French knot
 *
 * 名称：法国节 / Name: French knot
 *
 * 符号：fr.kn
 * Symbol: fr.kn
 *
 * 定义：基于法国海里定义的节 / Definition: Knot based on French nautical mile definition
 *
 * 来源：法国使用的航海速度单位 / Source: Maritime velocity unit used in France
*/
 ...
 * Symbol: uk.kn
 *
 * 定义：基于英国海里定义的节 / Definition: Knot based on UK nautical mile definition
 *
 * 来源：英国使用的航海速度单位 / Source: Maritime velocity unit used in the UK
*/
 ...
 * 俄罗斯节 / Russian knot
 *
 * 名称：俄罗斯节 / Name: Russian knot
 *
 * 符号：ru.kn
 * Symbol: ru.kn
 *
 * 定义：基于俄罗斯海里定义的节 / Definition: Knot based on Russian nautical mile definition
 *
 * 来源：俄罗斯使用的航海速度单位 / Source: Maritime velocity unit used in Russia
*/
 ...
 * Symbol: us.kn
 *
 * 定义：基于美国海里定义的节 / Definition: Knot based on US nautical mile definition
 *
 * 来源：美国使用的航海速度单位 / Source: Maritime velocity unit used in the US
*/
 ...
 * 光速 / Light speed
 *
 * 名称：光速 / Name: light speed
 *
 * 符号：c / Symbol: c
 *
 * 定义：c = 299,792,458 m/s（精确值） / Definition: c = 299,792,458 m/s (exact value)
 *
 * 来源：物理学基本常数，相对论中的速度上限 / Source: Fundamental constant in physics, speed limit in relativity
*/
 ...
 *
 * 来源：英制速度单位 / Source: Imperial velocity unit
*/
 ...
 *
 * 来源：英制速度单位，常用于美国工程领域 / Source: Imperial velocity unit, commonly used in US engineering
*/
 ...
 *
 * 来源：英制速度单位，广泛用于美国和英国的车辆速度表示 / Source: Imperial velocity unit, widely used for vehicle speed in the US and UK
*/
