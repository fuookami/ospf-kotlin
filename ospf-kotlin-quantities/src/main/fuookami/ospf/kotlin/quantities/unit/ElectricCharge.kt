 ...
 * 同时提供电容单位，包括法拉、毫法、微法、纳法、皮法等。 / Provides SI unit definitions for electric charge dimension, including coulomb, millicoulomb, ampere-hour, milliampere-hour, etc.
 ...
 * 库仑 / Coulomb
 *
 * 电荷的 SI 导出单位。 / SI derived unit for electric charge.
 *
 * 定义：1 C = 1 A × 1 s / Definition: 1 C = 1 A × 1 s
*/
 ...
 * 毫库仑 / Millicoulomb
 *
 * 定义：1 mC = 10⁻³ C / Definition: 1 mC = 10⁻³ C
*/
 ...
 * 微库仑 / Microcoulomb
 *
 * 定义：1 µC = 10⁻⁶ C / Definition: 1 µC = 10⁻⁶ C
*/
 ...
 * 千库仑 / Kilocoulomb
 *
 * 定义：1 kC = 10³ C / Definition: 1 kC = 10³ C
*/
 ...
 * 安时 / Ampere-hour
 *
 * 常用于电池容量表示。 / Commonly used for battery capacity.
 *
 ...
 * 安秒 / Ampere-second
 *
 * 定义：1 As = 1 C / Definition: 1 As = 1 C
*/
 ...
 * 法拉 / Farad
 *
 * 电容的 SI 导出单位。 / SI derived unit for capacitance.
 *
 * 定义：1 F = 1 C / V / Definition: 1 F = 1 C / V
*/
 ...
 * 毫法 / Millifarad
 *
 * 定义：1 mF = 10⁻³ F / Definition: 1 mF = 10⁻³ F
*/
 ...
 * 微法 / Microfarad
 *
 * 定义：1 µF = 10⁻⁶ F / Definition: 1 µF = 10⁻⁶ F
*/
 ...
 * 纳法 / Nanofarad
 *
 * 定义：1 nF = 10⁻⁹ F / Definition: 1 nF = 10⁻⁹ F
*/
 ...
 * 皮法 / Picofarad
 *
 * 定义：1 pF = 10⁻¹² F / Definition: 1 pF = 10⁻¹² F
*/
