 ...
 *
 * @return 货物类型的三维放置，若底层单元不是货物则返回 null / item-typed 3D placement, or null if the underlying unit is not an Item
*/
 ...
 * 转换为pItemPlacements。
 * @param placements 待筛选的货物放置列表 / item placements to filter
 * @return 位于顶面的货物放置列表 / item placements that are on the top surface
*/
 ...
 * bottomItemPlacements。
 * @param placements 待筛选的货物放置列表 / item placements to filter
 * @return 位于底面的货物放置列表 / item placements that are on the bottom surface
*/
