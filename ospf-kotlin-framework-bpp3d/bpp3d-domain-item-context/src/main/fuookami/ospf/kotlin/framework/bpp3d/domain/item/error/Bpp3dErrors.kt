/**
 * BPP3D 领域错误类型 / BPP3D domain error types
 *
 ...
 *
 * 用于 BPP3D 领域中不支持的能力错误。 / Used for capability-not-supported errors in the BPP3D domain.
 *
 ...
 *
 * 用于 BPP3D 领域中求解相关的错误。 / Used for solving-related errors in the BPP3D domain.
 *
 ...
 *
 * 用于 BPP3D 领域中的内部逻辑错误。 / Used for internal logic errors in the BPP3D domain.
 *
 * @property detail 错误详情 / Error detail
*/
 ...
 *
 * 用于 BPP3D 领域中的参数验证错误。 / Used for parameter validation errors in the BPP3D domain.
 *
 * @property detail 错误详情 / Error detail
*/
