/**
 * PWL 连续半径近似配置与断点策略。 / PWL continuous-radius approximation config and breakpoint strategies.
*/
...
/**
 * PWL 连续半径近似配置。 / PWL continuous-radius approximation config.
 *
...
/**
 * 断点生成策略。 / Breakpoint generation strategy.
*/
