 ...
 * 欠产变量结果（建模层扁平类型，从 solver solution 回填） / Unlike [UnderProduction] in YieldModel.kt (analysis-layer rich type), this type only records solver variable values
 ...
 * 超产变量结果（建模层扁平类型，从 solver solution 回填） / Unlike [OverProduction] in YieldModel.kt (analysis-layer rich type), this type only records solver variable values
 * and does not hold domain objects such as ProductDemand or Quantity.
