/**
 * CSP1D 领域错误类型 / CSP1D domain error types
 *
 ...
 *
 * 用于 CSP1D 应用生命周期相关的错误（注册、恢复、上下文等）。 / Used for errors related to the CSP1D application lifecycle (registration, recovery, context, etc.).
 *
 ...
 *
 * 用于 CSP1D 领域中不支持的类型错误。 / Used for unsupported type errors in the CSP1D domain.
 *
 ...
 *
 * 用于 CSP1D 领域中求解相关的错误。 / Used for solving-related errors in the CSP1D domain.
 *
 * @property detail 错误详情 / Error detail
*/
 ...
 *
 * 用于 CSP1D 领域中不支持的能力错误。 / Used for capability-not-supported errors in the CSP1D domain.
 *
