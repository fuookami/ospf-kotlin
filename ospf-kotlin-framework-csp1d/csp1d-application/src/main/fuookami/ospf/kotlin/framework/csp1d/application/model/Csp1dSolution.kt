...
object Csp1dKpiKeys {
    ...
    const val InitialGenerationKnifeBoundPrunedNodes = "initialGeneration.knifeBoundPrunedNodes"
    ...
    const val InitialGenerationMaterialSliceTemplateCacheHits = "initialGeneration.materialSliceTemplateCacheHits"
    const val InitialGenerationQuantityCacheHits = "initialGeneration.quantityCacheHits"
    const val InitialGenerationQuantityCacheMisses = "initialGeneration.quantityCacheMisses"
    const val InitialGenerationMaterialSliceTemplateCacheMisses = "initialGeneration.materialSliceTemplateCacheMisses"
    const val InitialGenerationCrossWorkerDuplicateCandidates = "initialGeneration.crossWorkerDuplicateCandidates"
    const val InitialGenerationCrossContributionDominated = "initialGeneration.crossContributionDominated"
    ...
    const val InitialKnifeBoundPrunedNodes = "initialKnifeBoundPrunedNodes"
    ...
    const val InitialMaterialSliceTemplateCacheHits = "initialMaterialSliceTemplateCacheHits"
    ...
    const val PricingVisitedNodes = "pricingGeneration.visitedNodes"
    const val PricingGeneratedCandidates = "pricingGeneration.generatedCandidates"
    const val PricingAcceptedPlans = "pricingGeneration.acceptedPlans"
    const val PricingInfeasibleCandidates = "pricingGeneration.infeasibleCandidates"
    const val PricingDuplicateCandidates = "pricingGeneration.duplicateCandidates"
    const val PricingDominatedCandidates = "pricingGeneration.dominatedCandidates"
    const val PricingElapsedMilliseconds = "pricingGeneration.elapsedMilliseconds"
    const val PricingStopReason = "pricingGeneration.stopReason"
    const val LpFailureMessage = "lpFailureMessage"
